...
\begin{DoxyCompactList}\small\item\em \hyperlink{structXputty}{Xputty} -\/ the main struct. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Macros}
\begin{DoxyCompactItemize}
\item 
...
\begin{DoxyCompactList}\small\item\em main\+\_\+run -\/ the main event loop \end{DoxyCompactList}\item 
